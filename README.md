...
<p align="center">
  <a href="https://kaiju-phi.vercel.app" target="_blank">
    <img src="https://img.shields.io/badge/Live_Demo-kaiju--phi.vercel.app-E50914?style=for-the-badge&logo=vercel&logoColor=white" alt="Live Demo" />
  </a>
...
> **KAIJU** is a modern, high-performance, mobile-first web application for exploring trending anime, top manga, and detailed statistics. Built with React 19, Vite 8, and Tailwind CSS v4, it features real-time search, hero spotlight carousels, genre filtering, and comprehensive details pages powered by the **Jikan REST API (MyAnimeList)**.

🌐 **Live Demo:** [kaiju-phi.vercel.app](https://kaiju-phi.vercel.app)
...
- 📱 **Mobile-First Native Experience**
  - Glassmorphic top navigation drawer and responsive mobile menu.
...
└── KAIJU/                  # Frontend Application Root
    ...
    │   │   ├── Navbar.jsx          # Top navbar, search & drawer
